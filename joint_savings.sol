...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        require(recipient == accountOne || recipient == accountTwo, "This recipient is not authorized for a withdrawl.");
        ...
        */
        require(amount < contractBalance, "There are not enough funds to withdraw the specified amount.");
